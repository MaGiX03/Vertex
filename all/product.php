<!DOCTYPE html>
<? $row = mysqli_fetch_assoc(mysqli_query($CONNECT, "SELECT * FROM products WHERE id = '$url_number' ")); ?>
<html class="wide wow-animation" lang="en">
<head>
	<title><? echo $row['p_name']; ?></title>
	...
	<div class="page">
		<div id="home">
			...
			<section class="section section-sm section-first bg-default text-center">
				<div class="container">
					<img src="images/product/<? echo $row['p_img']; ?>"  alt="" width="515" height="692"/>
					<h2 class="wow fadeInLeft"><? echo $row['p_name']; ?></h2>
					<p  style="font-size: 18px;"><? echo $row['p_text']; ?></p>					
				</div>
			</section>
