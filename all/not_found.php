...
<body>
  ...
  <div class="page">
    ...
    <section class="section section-fluid bg-default">
      <div class="parallax-container" data-parallax-img="images/slider-1-slide-2-1770x742.jpg" style="padding-bottom: 200px;">
        <div class="parallax-content section-xl context-dark bg-overlay-68 bg-mobile-overlay">
          <div class="container">
            <h3 class="wow fadeInLeft">Страница не найдена</h3>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container-fluid">
        <div class="footer-minimal-inset oh">
          <ul class="footer-list-category-2">
            ...
            <li><a href="#">+7 (777) 333-22-11</a></li>
          </ul>
        </div>
